...
- Feature credit (Entitlement grants) entries can now be [updated](/api-reference/entitlements/update-a-feature-credits-entry-of-a-feature-for-an-account) as well as [voided](http://localhost:3000/api-reference/entitlements/void-a-feature-credits-entry-of-a-feature-for-an-account). 
