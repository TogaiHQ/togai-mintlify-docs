...
- Fixed Fees are now supported in Purchase plan
- Proration of fixed fees are now supported in `in-advance` timing mode.
- Feature credit entries can now be [updated](/api-reference/entitlements/update-a-feature-credits-entry-of-a-feature-for-an-account) as well as [voided](http://localhost:3000/api-reference/entitlements/void-a-feature-credits-entry-of-a-feature-for-an-account). 
- [Metrics API](http://localhost:3000/api-reference/metrics/get-togai-metrics) fix - endTime made exclusive
