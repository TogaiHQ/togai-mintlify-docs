...
Togai's Usage-Based metering and billing platform has quotas and limits to manage API requests and resource creation within an organization. The values mentioned below are for testing purpose. Since we allow users to test signup and test Togai without any restrictions, we have limits that reflect such a scenario. Customers can adjust these limits when they go live by reaching out to us via chat or [email](mailto:support@togai.com).
...
To adjust a quota, please contact Togai's customer support team through chat or at 📧 [support@togai.com](mailto:support@togai.com)